...
function ServiceInformation() {
  ...
  const goToServiceDetail = () => {
    navigate(`/servicedetail/${params.id}`);
  };
      ...
      <div className="relative bottom-[160px] xl:bottom-auto xl:static flex flex-col items-center">
        ...
        <div className="px-3 pt-20 pb-6 flex flex-col gap-3">
          ...
          <div className="xl:w-1/3">
            ...
            <div
              tabIndex={0}
              className="hidden xl:block collapse-open bg-white border border-b-0 xl:border-b-2 border-gray-300 rounded-b-none rounded-t-lg "
            >
              ...
              <div className="collapse-content text-[14px] pb-0">
                <ul className="text-sm">
                  {orderItems.map((item) => (
                    <li
                      className="md:pb-4 flex flex-col border-b-2 border-gray-300"
