...
function Contact() {
  return (
    <div className="xl:w-screen xl:flex xl:justify-center">
      <div className="w-[375px] h-[731px] flex-col justify-start items-start inline-flex mt-28 lg:w-[1440px] lg:h-[378px] lg:relative lg:bg-blue-600 lg:mt-0">
...
"
          ...
          <img
            className="w-[375px] h-[306px] left-[0px] top-[2050px] absolute lg:absolute lg:top-[0px] lg:h-[378px] lg:w-[500px] "
            src={photo}
          />
          <img
            className="w-[306px] h-[306px] left-[69px] top-[2558px] absolute lg:absolute lg:top-[73px] lg:left-[1135px]"
            src={houselogo}
          />
        </div>
      </div>
